...
while($info = mysql_fetch_array($q)){
        ...
        ////////////////// IF SHOW POSTS INSTEAD OF USERNAME
            ...
            $getPackage = mysql_query("SELECT * FROM `packages` WHERE `id` = '{$info['packageid']}' LIMIT 1");
            $getPackageInfo = mysql_fetch_array($getPackage);
            ...
            if($type=='missing'){//MISSING ORDER NUMBERS
                        	...
                        	$articles .= '<tr>
                                            ...
                                            '.$attempt_date.'
                                            '.$supplier_error.'
                                            Package Id: '.$getPackageInfo['id'] .' ('. $getPackageInfo['amount'] .' '. $getPackageInfo['type'] .')<br>
                                            Package JAP Id: '.$getPackageInfo['jap1'] .'<br>
