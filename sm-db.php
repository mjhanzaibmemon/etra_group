...
function writeCloudWatchLog($page, $log, $logGroupName = 'etra-ec2-logs') {
    global $cloudwatchkey, $cloudwatchpassword;
    ...
    $date = date('Y-m-d');
    $logStreamName = 'logs_' . $date . '_' . $page;
...
if (strpos($_SERVER['SERVER_NAME'], 'etra.group') !== false || strpos($_SERVER['SERVER_NAME'], 'superviral.io') !== false || strpos($_SERVER['SERVER_NAME'], 'keyshock.com') !== false){}else{die('Error');}//Protection from Nameserver imitation
