...
writeCloudWatchLog('crons-revenue-notification', ' Token response: '. $response);
...
$response = curl_exec($curl);
writeCloudWatchLog('crons-revenue-notification', ' US data response: '. $response);
$err = curl_error($curl);
...
writeCloudWatchLog('crons-revenue-notification', ' UK data response: '. $response);
$err = curl_error($curl);
